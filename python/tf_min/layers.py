"""
    ...
    These layers also support automatic quantization of weights and the generation of
    equivalent fixed point versions. Automating the process of converting a model trained
    with floating point calculations into a model using fixed point calculations.
"""
